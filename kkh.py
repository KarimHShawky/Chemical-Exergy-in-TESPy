...
2002-02-10:
-Koeffizientenbezeichnung in Kommentaren korrigiert
-N2 Werte ergänzt
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++

Created on Thu Mar 16 09:47:10 2017
...
c = {'C':      [-2.101,  -6.540,  0.109,  38.940, -0.146, -17.385, 12.011],
     ...
     'N2':     [-9.982,  16.203, 30.418,   2.544, -0.238,   0.0,   28.0134],   #original values
#     'N2':     [-7.069,  51.539, 24.229,  10.521,  0.180,  -2.315, 28.0134],   #updated values
     ...
     'H2Og': [-253.871, -11.750, 34.376,   7.841, -0.423,   0.0,   18.0152],
...
class kkh:
    ...
    def enthalpy_mass(b, t):
        y = t*1E-3
        hm = (1E3*(c[b][0]+c[b][2]*y+c[b][3]/2*y**2-c[b][4]/y+c[b][5]/3*y**3))/c[b][6]
        return hm
