...
fluid_list = ['KKH::O2', 'KKH::H2O', 'KKH::N2', 'KKH::CO2', 'KKH::CH4']
nwk = Network(fluids=fluid_list, p_unit='bar', T_unit='C', h_range=[-1e9, 1e7])

air_molar = {
    'O2': 0.2059, 'N2': 0.7748, 'CO2': 0.0003, 'H2O': 0.019, 'CH4': 0
}
molar_masses = {
    'O2': 31.9988, 'N2': 28.0134, 'CO2': 44.0098, 'H2O': 18.0152, 'CH4': 16.0426
}
...
c3.set_attr(p=1.013, T=850 - 273.15, fluid=air, m=91.2757)
...
result.to_csv('CGAM_combustion_KKH.csv')
